...
public class maintainLineRenderer : MonoBehaviour
{
    ...
    public void changeNumberOfPointsTime_v2()
    {
        ...
        newChartG.GetSample(station, specificTimeFixed, numberOfPoints, staticFunctions.FindChildByRecursion(this.transform.parent, "VegaLiteIntegration").gameObject);
    ...
    public void changeNumberOfPointsKPI_v2()
    {
        ...
        newChartG.GetSample(station, specificKPIFixed, numberOfPoints, staticFunctions.FindChildByRecursion(this.transform.parent, "VegaLiteIntegration").gameObject);
