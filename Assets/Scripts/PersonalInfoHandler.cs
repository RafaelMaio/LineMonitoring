...
public class PersonalInfoHandler : MonoBehaviour
{
    ...
    public void changeToSpecificCycleTime(string specificTime)
    {
        ...
        staticFunctions.FindChildByRecursion(cycleTimeSpecific.transform, "SampleNumberSlider").GetComponent<PinchSlider>().SliderValue = 0.2f;
        ...
        maintainLineOnCycle.setPersonalInfoCycleTime(
            Int32.Parse(staticFunctions.FindChildByRecursion(cycleTimeSpecific.transform, "Title").GetComponent<TMP_Text>().text.Split(" /")[0].Split(": ")[1]),
            Int32.Parse(staticFunctions.FindChildByRecursion(cycleTimeSpecific.transform, "Title").GetComponent<TMP_Text>().text.Split("Station: ")[1]),
            specificTimeFixed
        );
        maintainLineOnCycle.changeNumberOfPointsTime();
    ...
    public void changeToSpecificKPI(string specificKPI)
    {
        ...
        staticFunctions.FindChildByRecursion(kpiSpecific.transform, "ShiftNumberSlider").GetComponent<PinchSlider>().SliderValue = 0.2f;
        ...
        maintainLineOnKPIs.setPersonalInfoKPI(
            Int32.Parse(staticFunctions.FindChildByRecursion(kpiSpecific.transform, "Title").GetComponent<TMP_Text>().text.Split(" /")[0].Split(": ")[1]),
            Int32.Parse(staticFunctions.FindChildByRecursion(kpiSpecific.transform, "Title").GetComponent<TMP_Text>().text.Split("Station: ")[1]),
            specificKPIFixed
        );
