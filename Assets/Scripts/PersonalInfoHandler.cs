...
public class PersonalInfoHandler : MonoBehaviour
{
    ...
    public void changeToSpecificCycleTime(string specificTime)
    {
        ...
        staticFunctions.FindChildByRecursion(cycleTimeSpecific.transform, "SampleNumberSlider").GetComponent<PinchSlider>().SliderValue = 1f;
    ...
    public void changeToSpecificKPI(string specificKPI)
    {
        ...
        staticFunctions.FindChildByRecursion(kpiSpecific.transform, "ShiftNumberSlider").GetComponent<PinchSlider>().SliderValue = 1f;
